...
class CnnBenchmark:
    ...
    def _benchmark(self,
        ...
        # ACC, Prec, Recall, F1
        accuracy_score, precision_score, recall_score, F1_score = calculate_f1(input,
                                                                               target,
                                                                               False)
