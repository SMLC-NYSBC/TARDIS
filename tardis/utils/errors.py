...
class TardisError(Exception):
    ...
    def __init__(self, id="0", py="NA", desc="Unknown exertion occurred!"):
        ...
        desc_3, desc_4, desc_5, desc_6, desc_7, desc_8, desc_9, desc_10 = self.cut_desc(desc)
        self.tardis_error_rise(
            title=f"TARDIS ERROR CODE {id} {id_desc} \n",
    ...
    @staticmethod
    def _truncate_str(desc: str, width: int) -> Tuple[str, str, str, str, str, str, str, str]:
        """
