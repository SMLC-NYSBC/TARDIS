...
def main(gf_dir: str,
    ...
    if scannet:
        tardis_logo(title='Metric evaluation for DIST',
                    text_2=f'DIST model scored with:')
        classes_eval = []
