...
@click.option(
    "-ms", "--mask_size", default=150, type=int, help="Size of drawn mask in A.", show_default=True
)
@click.option(
    "-cnn",
    "--cnn_type",
...
@click.option(
    "-b", "--training_batch_size", default=25, type=int, help="Batch size.", show_default=True
)
@click.option(
    "-cl",
    "--cnn_layers",
...
@click.option(
    "-cmpk", "--pool_kernel", default=2, type=int, help="Max_pooling kernel.", show_default=True
)
@click.option(
    "-l",
    "--cnn_loss",
...
@click.option(
    "-w", "--warmup", default=100, type=int, help="Number of warmup steps.", show_default=True
)
