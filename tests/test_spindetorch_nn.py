...
def unet3plus_3d(image_size: int,
                 layer_num: int,
                 conv_scaler: int,
                 dropout: Optional[float] = None):
    structure.update({'layer_components': '3gcl'})
...
def unet3plus_2d(image_size: int,
                 layer_num: int,
                 conv_scaler: int,
                 dropout: Optional[float] = None):
    structure.update({'layer_components': '2gcl'})
