...
def test_trim_stitch_3d():
    ...
    trim_with_stride(image=image_3d_15,
                     trim_size_xy=15,
                     trim_size_z=15,
    ...
    stitch_3d_15 = stitch(image_dir='./tests/test_data/temp/imgs',
                          mask=False,
                          dtype=np.float32)
    ...
    trim_with_stride(image=image_3d_150,
                     trim_size_xy=64,
                     trim_size_z=64,
                     output='./tests/test_data/temp',
                     image_counter=0,
...
def test_trim_stitch_2d():
    ...
    trim_with_stride(image=image_2d_15,
                     trim_size_xy=15,
                     trim_size_z=15,
                     output='./tests/test_data/temp',
                     image_counter=0,
    ...
    stitch_2d_15 = stitch(image_dir='./tests/test_data/temp/imgs',
                          mask=False,
                          dtype=np.float32)
    ...
    trim_with_stride(image=image_2d_150,
                     trim_size_xy=64,
                     trim_size_z=64,
                     output='./tests/test_data/temp',
                     image_counter=0,
