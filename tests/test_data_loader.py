...
class TestLoader:
    ...
    def test_tif2D(self):
        ...
        assert image.shape == (64, 64), \
            'Error while loading .tif. Incorrect image shape!'
    ...
    def test_mrc2D(self):
        image, pixel_size = loader.import_mrc(join('tests',
                                                   ...
                                                   'mrc2D.mrc'))
        assert image.shape == (64, 64), \
            'Error while loading .mrc. Incorrect image shape!'
    ...
    def test_rec3D(self):
        image, pixel_size = loader.import_mrc(join('tests',
                                                   ...
                                                   'rec3D.rec'))
        assert image.shape == (64, 64, 64), \
            'Error while loading .rec. Incorrect image shape!'
        assert pixel_size == 2.32, 'Pixel size was not detected correctly!'
    ...
    def test_am3D(self):
        image, pixel_size = loader.import_am(join('tests',
                                                  ...
                                                  'am3D.am'))
        assert image.shape == (64, 64, 64), \
            'Error while loading .am. Incorrect image shape!'
        assert pixel_size == 2.32, 'Pixel size was not detected correctly!'
