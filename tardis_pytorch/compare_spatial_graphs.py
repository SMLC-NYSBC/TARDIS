...
from tardis_pytorch.utils.spline_metric import SpatialGraphCompare
...
@click.option(
    ...
    default=getcwd(),
    type=str,
    help="Directory with spatial graphs from amira and tardis_pytorch.",
    show_default=True,
)
@click.option(
    "-o",
...
@click.option(
    ...
    default=None,
    type=str,
    help="Prefix name for tardis_pytorch spatial graph.",
    show_default=True,
)
@click.option(
    "-th_dist",
...
def main(
    ...
    if dir is None:
        TardisError(
            id="122",
            py="tardis_pytorch/compare_spatial_graphs.py",
