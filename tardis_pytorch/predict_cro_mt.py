...
from tardis_pytorch.spindletorch.data_processing.trim import (
    scale_image,
    trim_with_stride,
)
...
from tardis_pytorch.utils.export_data import NumpyToAmira, to_mrc
from tardis_pytorch.utils.load_data import import_am, load_image
from tardis_pytorch.utils.logo import print_progress_bar, TardisLogo
from tardis_pytorch.utils.normalization import MinMaxNormalize, RescaleNormalize
...
def main(
    ...
    for id, i in enumerate(sorted(predict_list)):
        ...
        image = image_stitcher(image_dir=output, mask=True, dtype=input.dtype)[
